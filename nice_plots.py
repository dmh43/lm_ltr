...
def doc():
  ...
  docs, lookup = pickle.load(open('parsed_docs_500_tokens.pkl', 'rb'))
  ...
  print(np.corrcoef(abs(w_subset), tfs_in_order)[0, 1])
  print(np.corrcoef(abs(w_subset), dfs_in_order)[0, 1])
  print(np.corrcoef(abs(w_subset), idfs_in_order)[0, 1])
  print(np.corrcoef(abs(w_subset), norms_in_order)[0, 1])
  print(np.corrcoef(abs(w_subset), np.log(tfs_in_order + 1))[0, 1])
  print(np.corrcoef(abs(w_subset), np.log(dfs_in_order))[0, 1])
  print(np.corrcoef(abs(w_subset), np.log(idfs_in_order))[0, 1])
  print(np.corrcoef(abs(w_subset), np.log(norms_in_order + 1))[0, 1])
