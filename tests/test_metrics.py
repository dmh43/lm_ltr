...
def test_metrics_at_k():
  ...
  assert metric.metrics_at_k(dataset, k=1) == {'precision': 1.0, 'recall': 9.0 / 26, 'ndcg': 1.0}
  assert metric.metrics_at_k(dataset, k=3) == {'precision': 26.0 / 27, 'recall': 1.0, 'ndcg': 1.0}
  assert metric.metrics_at_k(dataset, k=6) == {'precision': 26.0 / 54, 'recall': 1.0, 'ndcg': 1.0}
