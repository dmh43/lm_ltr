...
def train_model(model, documents, train_dl, test_dl, query_document_token_mapping):
  print('Creating ranking datasets')
  train_ranking_dataset = RankingDataset(documents, train_dl.dataset.data, query_document_token_mapping, k=1)
  test_ranking_dataset = RankingDataset(documents, test_dl.dataset.data, query_document_token_mapping, k=1)
